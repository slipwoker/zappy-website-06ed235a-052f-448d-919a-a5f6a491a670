document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('blur', function (e) {
      ...
      if (!field || field.type === 'submit' || field.type === 'button' || field.type === 'hidden') return;
      validateField(field);
    }, true);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רעציק סגל-תווך מוריה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '06ed235a-052f-448d-919a-a5f6a491a670',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '06ed235a-052f-448d-919a-a5f6a491a670';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '06ed235a-052f-448d-919a-a5f6a491a670';
